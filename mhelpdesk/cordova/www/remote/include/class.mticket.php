...
class MobileTicket {
	...
	function load() {
		...
		$sql=' SELECT  ticket.*, DATE_FORMAT(ticket.created,"%d-%m-%Y %h:%i") AS fcreated, topic.topic as topic,topic.topic_id as topicId,lock_id,dept_name,priority_desc'.
			' FROM rz_ticket ticket '.
