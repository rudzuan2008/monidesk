...
switch ($thistab) {
    ...
    case 'faq':
        ...
        $nav->addSubMenu(array('desc' => _('FAQ ITEMS'), 'href' => 'admin.php?t=faq', 'iconclass' => 'helpTopics'));
        $nav->addSubMenu(array('desc' => _('ADD NEW FAQ'), 'href' => 'admin.php?t=faq&a=new', 'iconclass' => 'newHelpTopic'));
        ...
        $page = ($faq or ($_REQUEST['a'] == 'new' && !$faqID)) ? 'faq.inc.php' : 'faqitem.inc.php';
        break;
