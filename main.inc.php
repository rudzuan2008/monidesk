...
if (!db_connect(DBHOST,DBUSER,DBPASS,DBNAME)) {
    ...
    $ferror='Short open tag disabled! - Helpdesk-support requires it is turned ON.';
}

if($ferror) { //Fatal error
    Sys::alertAdmin('Helpdesk-support fatal error', 'Server ' . $_SERVER['SERVER_NAME'] . $_SERVER['PHP_SELF'] . ': ' . $ferror); //try alerting sysadmin.
