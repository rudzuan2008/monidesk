...
function showData($table, $type)
{
	...
	//echo $dir;
	$sql_count="SELECT  ticket.*,".
			' DATE_FORMAT(ticket.created,"%d-%m-%Y %h:%i") AS fcreated, topic.topic as topic,'.
			' asset.name asset_name, asset.description asset_address, asset.serial_no asset_unit,'.
			' topic.topic_id as topicId,lock_id,dept_name,priority_desc FROM rz_ticket ticket '.
            ...
            ' LEFT JOIN rz_asset asset ON ticket.asset_id=asset.asset_id '.
