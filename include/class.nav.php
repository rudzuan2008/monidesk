...
class StaffNav {
    ...
    function StaffNav($pagetype='staff'){
        ...
        if($thisuser->isAdmin() && strcasecmp($pagetype,'admin')==0) {
            ...
            $tabs['faq']=array('desc'=>_('FAQ Items'),'href'=>'admin.php?t=faq','title'=>_('FAQ Items'));
            ...
            $tabs['staffreport']=array('desc'=>_('Reports'),'href'=>'report.php','title'=>_('Operational Reports'));
        }
        $this->tabs=$tabs;    
    }
