...
<div><b><?=$showing?></b></div>
   ...
   <tr><td>
    <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        ...
	        <th width="170" nowrap>&nbsp;&nbsp;
                    <a href="admin.php?t=templates&sort=date&order=<?=$negorder?><?=$qstr?>" title="<?= _('Sort By Date of Creation') ?> <?=$negorder?>"><?= _('Last Update') ?></a></th>
 ...
 <table width="100%" border="0" cellspacing=1 cellpadding=2>
     <tr><td width="50%"><b><?= _('Base Variables') ?></b></td><td><b><?= _('Other Variables') ?></b></td></tr>
    <tr>
        <td width="50%">
            <table width="100%" border="0" cellspacing=1 cellpadding=1>
                ...
                <tr><td>%phone</td><td><?= _('Phone number') ?></td></tr>
                ...
                <tr><td>%createdate</td><td><?= _('Created on') ?></td></tr>
        ...
        <td>
            <table width="100%" border="0" cellspacing=1 cellpadding=1>
                ...
                <tr><td>%url</td><td><?= _('EDC Helpdesk-support\'s base url (FQDN)') ?></td></tr>
